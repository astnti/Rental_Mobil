    ...
    <div class="form-group">
         ...
         <select class="form-control" name="kostumer" disabled>
              ...
              <?php foreach($kostumer as $k){ ?>
               <option <?php if($t->transaksi_kostumer == $k->kostumer_id){echo "selected='selected'";} ?> value="<?php echo $k->kostumer_id; ?>">
               <?php echo $k->kostumer_nama; ?></option>
               <?php } ?>
         </select>
    </div>
    ...
    <div class="form-group">
         ...
         <select class="form-control" name="mobil" disabled>
              ...
              <?php foreach($mobil as $m){ ?>
               <option <?php if($t->transaksi_mobil == $m->mobil_id){echo "selected='selected'";} ?> value="<?php echo $m->mobil_id; ?>">
               <?php echo $m->mobil_merk; ?></option>
               <?php } ?>
         </select>
    </div>
