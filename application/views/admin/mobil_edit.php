...
<?php foreach($mobil as $m){ ?>
    ...
    <div class="form-group">
        ...
        <select name="status" class="form-control">
            <option <?php if($m->mobil_status == "1"){echo "selected='selected'";} echo $m->mobil_tahun; ?> value="1">Tersedia</option>
            <option <?php if($m->mobil_status == "2"){echo "selected='selected'";} echo $m->mobil_tahun; ?> value="2">Sedang Di Rental</option>
        </select>
