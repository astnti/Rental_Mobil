...
?>">
   ...
   <div class="btn-group">
         <a class="btn btn-warning btn-sm" href="<?php echo base_url().'admin/laporan_pdf/?dari='
         .set_value('dari').'&sampai='.set_value('sampai') ?>"><span class="glyphicon glyphicon-print"></span> Cetak PDF</a>
         <a class="btn btn-default btn-sm" href="<?php echo base_url().'admin/laporan_print/?dari='
         .set_value('dari').'&sampai='.set_value('sampai') ?>"><span class="glyphicon glyphicon-print"></span> Print</a>
   </div>
<br/>
<br/>
           ...
           <tbody>
               ...
               foreach($laporan as $l){ 
                ...
                <tr>
                    ...
                    <td>
                       <?php 
                       if($l->transaksi_tgldikembalikan =="0000-00-00"){echo "-";
                       }else{
